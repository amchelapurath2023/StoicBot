...
def calendar_day_to_int(date):
    ...
    if (date.day == 22 and date.month == 1) or (date.day == 26 and date.month == 1) or (date.day == 29 and date.month == 1) or (date.day == 11 and date.month == 3) or (date.day == 26 and date.month == 4) or (date.day == 4 and date.month == 6) or (date.day == 15 and date.month == 6) or (date.day == 7 and date.month == 9) or (date.day == 10 and date.month == 9) or (date.day == 20 and date.month == 9) or (date.day == 24 and date. month == 9) or (date.day == 26 and date.month == 9) or (date.day == 10 and date.month == 10) or (date.day == 21 and date.month == 10) or (date.day == 22 and date.month == 12) or (date.day == 27 and date.month == 12):
        total_offset += 1
    if date.day == 1 and (date.month == 1 or 2 or 3 or 4 or 5 or 6 or 7 or 8 or 9 or 10 or 11 or 12):
        total_offset += 1
